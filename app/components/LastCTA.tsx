  ...
  return (
    <div className="py-10 px-5 bg-light-background text-light-text">
      <div className="text-center w-full pt-5">
        <h1 className="text-2xl font-bold pb-3">Your Financial Freedom Starts Today!</h1>
        <p className="text-sm">
          Join <strong>50,000+</strong> users transforming their savings with Trexpenser.
        </p>
      </div>
      ...
      <div className="flex flex-col p-3 gap-5 md:flex-row">
        ...
        <div className="flex flex-col gap-3 items-center justify-center">
          ...
          <p>
            Trexpenser empowers you to take control of your finances with smart tools designed for
            success. Save smarter, not harder.”
          </p>
        </div>
        <div
        ...
        >
          ...
          <p className="text-sm text-center">
            Hurry! Last week alone, <strong>2,000 </strong>new users joined Trexpenser!”.
          </p>
        </div>
      </div>
        ...
        <div>
          ...
          <div className="grid grid-cols-1 py-10">
            <div className="flex gap-3 items-center">
              <FaCheck className="text-light-iconColor" /> <h1>Secured Payment</h1>
            </div>
            <div className="flex gap-3 items-center">
              <FaShieldHalved className="text-light-iconColor" /> <h1>SSL certified</h1>
            </div>
            <div className="flex gap-3 items-center">
        ...
        >
          ...
          <div>
            <p className="italic text-center">
              Trexpenser is a game-changer for anyone serious about saving!”
            </p>
          </div>
