      ...
      <div className="flex flex-col items-center justify-center p-5 gap-5">
        <div>
          ...
          <p className="text-center pt-2">
            Trexpenser empowers you to track expenses, manage savings, and achieve financial freedom
            with ease. Our intuitive platform provides personalized insights and automated tools,
            ensuring your money works for you. Join a community of smart savers and start building
            your brighter financial future today.
          </p>
        </div>
        <Link
          href="/signup"
